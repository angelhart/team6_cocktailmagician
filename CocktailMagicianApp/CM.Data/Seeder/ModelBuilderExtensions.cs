	...
	public static class ModelBuilderExtensions
	{
		public static void Seed(this ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<AppRole>().HasData(
				new AppRole { Id = new Guid("a6dc0db8-408c-4aff-bf99-0d46efd31787"), Name = "Magician", NormalizedName = "MAGICIAN" },
				new AppRole { Id = new Guid ("acde9ca2-de8c-45a0-ad81-3c3b05c8c90e"), Name = "BarCrawler", NormalizedName = "BARCRAWLER" }
			);
		}
	}
}
